...
export const addReaction = async (req, res) => {
  try {
    ...
    if (receiverSocketId) io.to(receiverSocketId).emit("reactionUpdated", { messageId, reactions: message.reactions });
    if (senderSocketId) io.to(senderSocketId).emit("reactionUpdated", { messageId, reactions: message.reactions });
